...
// 축소판 그림을 지원합니다.
void CtmpDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CtmpDoc::InitializeSearchContent()
{
...
void CtmpDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
